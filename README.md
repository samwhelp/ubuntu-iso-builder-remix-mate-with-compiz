...
# ubuntu-iso-builder-remix-mate-with-compiz
...
| `+` | `+` |
| [ubuntu-iso-builder-remix-mate-with-compiz](https://samwhelp.github.io/ubuntu-iso-builder-remix-mate-with-compiz/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-mate-with-compiz) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-mate-with-compiz](https://samwhelp.github.io/ubuntu-iso-builder-respin-mate-with-compiz/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-mate-with-compiz) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-mate-with-compiz/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-mate-with-compiz/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-mate-with-compiz/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-mate-with-compiz](https://github.com/samwhelp/ubuntu-iso-builder-remix-mate-with-compiz)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-mate-with-compiz.git
```


> change dir to `ubuntu-iso-builder-remix-mate-with-compiz`

``` sh
cd ubuntu-iso-builder-remix-mate-with-compiz
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-mate-with-compiz/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-mate-with-compiz/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-mate-with-compiz/iso-profile/dist`
...
| Link | GitHub |
| ---- | ------ |
| [Ubuntu / Mate with Compiz / Adjustment](https://samwhelp.github.io/ubuntu-mate-with-compiz-adjustment/) | [GitHub](https://github.com/samwhelp/ubuntu-mate-with-compiz-adjustment) |
| [Ubuntu / Mate with Compiz / Note](https://samwhelp.github.io/note-about-ubuntu-mate-with-compiz/) | [GitHub](https://github.com/samwhelp/note-about-ubuntu-mate-with-compiz) |
